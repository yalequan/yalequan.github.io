...
4.	**Quan, Y.**, & Wang. C. (2025, July 15-18) *A Neural Network Approach to Small Sample 
Intersectional DIF Detection* [Paper Presentation]. Annual International Meeting of the Psychometric Society (IMPS), Minneapolis, MN, USA.

5.	**Quan, Y.** (2025, May 9) *Using Categorical Structural Equation Models to Identify Facets of 
...
6.	**Quan, Y.**, Ren, H., & Wang, C. (2025, March 29) C*onstructing A Machine Learning Model 
...
7.	**Quan, Y.**, Sager, M. (2025, February 17-20) *Identifying Core Formal Assessment 
...
8.	**Quan, Y.**, & Ren, H. (2024, December 4) *Sample Size and Test Length Recommendations for 
...
9.	**Quan, Y.**, & Wang, C. (2024, November 17-18) *A New Item Fit Test for the Diagnostic Facet 
...
10.	**Quan, Y.** (2024, June 4) *Introduction to Bayesian Item Response Theory*, [Paper 
Presentation]. Center for Statistics and The Social Sciences Student Research Presentation, Seattle, WA, United Sates.

11.	**Quan, Y.** (2024, October 18) *Item Response Theory (IRT) Model Selection and Applications* 
[Invited Talk]. University of Washington Behavioral Research Center for HIV, Seattle, WA, United States.

12.	**Quan, Y.**, & Wang, C. (2024, April 11-14) *Parameter Recovery from Higher Order Item 
...
13.	**Quan, Y.**, & Wang, C. (2024, April 11-14) C*ollapsing or not? A Practical Guide to Handling 
...
14.	**Quan, Y.**, & Xiao, T. (2024, March 11) T*he Effects of Measurement Error on Multilevel 
...
15.	**Quan, Y.**, & Wang, C. (2022, April 12-15) T*he Effects of Sample Size and Collapse Direction 
...
16.	**Quan, Y.** (2021, December 3). *Clustering Education Data Using K-Medoids with 
...
1.	**Quan, Y.**, & Wang, C. (2025). Using Multi-label Classification Neural Network to Detect 
...
2.	**Quan, Y.**, & Ren, H. (2025). Sample Size and Assessment Length Recommendations for the 
	Diagnostic Status Facet Model. *PsyArXiv*. <a href="https://doi.org/10.31234/osf.io/zr3je_v1">https://doi.org/10.31234/osf.io/zr3je_v1</a>


MANUSCRIPTS UNDER REVIEW AND IN PREPERATION

1.	**Quan, Y.**, & Wang, C. (Under Review) Using Multi-label Classification Neural Networks to 
Detect Intersectional DIF with Small Sample Sizes. *British Journal of Mathematical and Statistical Psychology*

2.	Wang, C., **Quan, Y.**, Arthur, D. (Under Review) Review of Cognitive Diagnostic Models	(CDMs): Recent Methodological Advancements for Addressing Challenges in Applications. *British Journal of Mathematical and Statistical Psychology*

3.	**Quan, Y.**, & Wang, C. (In Preparation) Transitive DIF Clustering: A Graph-Theoretic Approach to Identifying Many-Group Partial Measurement Invariance. *Psychological Methods*

4.	Park, A., **Quan, Y.**, Lohr, M., & Oxford, M. (In Preparation). Concurrent and enduring 
predictors of preschool language among young children of parents involved in child welfare. *Journal of Speech, Language, and Hearing Research*
